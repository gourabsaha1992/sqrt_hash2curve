...
#if FP_PRIME == 575 || FP_PRIME == 571
#define RLC_G2_LOWER			ep8_
#define RLC_G2_BASEF(A)			A[0][0][0]
#elif FP_PRIME == 315 || FP_PRIME == 317 || FP_PRIME == 330 || FP_PRIME == 509 || FP_PRIME == 510 || FP_PRIME == 765 || FP_PRIME == 766 || FP_PRIME == 559
...
#elif FP_PRIME == 315 || FP_PRIME == 317 || FP_PRIME == 509 || FP_PRIME == 559
