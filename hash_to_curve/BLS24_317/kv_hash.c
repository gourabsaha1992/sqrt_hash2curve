...
void ep_map_koshelov(ep_t p, const uint8_t *msg, size_t len, fp_t c[8], fp_t w[8],bn_t e,fp_t B,fp_t bs) {
	...
	RLC_TRY {
		static const uint8_t DST[] = "KOSHELOV-BLS24-317-G1";
...
int main(void) {   
	...
	bn_new(tmp);
	bn_read_str(tmp,
    "39da48b2e8ad5f55f8ed1b5204be4bc723dcc6594b7f1b62d6a9be7cfe605603a6fe8001",
	...
	bn_read_str(tmp,
    "41bf106cbb32853e75125b39357efbae80a97f2a70581cb5475cb1ed4fa71f953b13ea7057d07d7",
    115,   // number of hex chars
    16);
	...
	bn_read_str(tmp,
    "12b5da1b402866ffbf4b4aace45372158656d46fe4e54943b1ea6588fbbabc85829fa751df47c",
    115,   // number of hex chars
    16);
	...
	bn_read_str(tmp,
    "1a1b8187ea4ba0b0e937c1b765382e0bc73bf7638cbdc0ba9c1fe539c88ebaac848a9ae12946447",
    115,   // number of hex chars
    16);
...
fp_t b,b2,b3,b4,bs,B;
	...
	bn_add_dig(e, e, 7);
	bn_div_dig(e, e, 27);
    const char *msg = "hashing to BLS24-317 and this is the message";
