...
void koshelov_a0_implt(ep_t p, const uint8_t *random, size_t len, fp_t c[2], fp_t w[2],bn_t e) {
	fp_t h[8], t1, t2, g0, den, num0, num1, num2, y0, y1, y2, d[3],temp1,temp2,four,one,theta,theta3,s1,s2,s12,s22,s3,nthree,x,y,k;
	ctx_t *ctx = core_get();
	bn_t kk;
	uint8_t s;
...
void ep_map_koshelov(ep_t p, const uint8_t *msg, size_t len, fp_t c[2], fp_t w[2],bn_t e) {
	...
	RLC_TRY {
		static const uint8_t DST[] = "KOSHELOV-BLS12-446-G1";
...
int main(void) {   
	...
	bn_new(tmp);
	bn_read_str(tmp,
    "3cdee0fb28c5e5351ff1566c3317a3e46ab67d82fc98625d069cbab50394969bf0edccbc59652f7dd09ae63cf057f4ef7defff92aa7eaaa6",
    112,   // number of hex chars
    16);
	...
	bn_read_str(tmp,
    "1e6cdd3293325b95df27348d6a9bd508d8eb96b7327f669160a10788d59e7086535eebd51bc0dcb32c009400320004",
    112,   // number of hex chars
    16);
	...
	bn_read_str(tmp,
    "2e288e3ff54c0c26290e4b49e1dad8812b506f0f33d20d23090017171a43a62521dc9728734e6ae8ea801b4678c58669efcc57599e0f01ee",
    112,   // number of hex chars
    16);
	...
	bn_read_str(tmp,
    "105acb350cb727789cadafcfff73929380809483efcacf1fb919db4bfd51d97015161cc2ef285f03b20eaf9307eaf916ffa0901c7f9e3b23",
    112,   // number of hex chars
    16);
	...
	bn_add_dig(e, e, 2);
	bn_div_dig(e, e, 9);
    const char *msg = "Hash to BLS12-446 and this is the massege";
